          ...
          >
            <motion.div variants={fadeInUp}>
              <span className="inline-block px-4 py-1 rounded-full bg-blue-100 text-blue-600 font-medium text-sm mb-4">
                Trusted Gas Provider in Kerala
              </span>
            </motion.div>
            ...
            >
              Delivering clean, reliable, and efficient LPG solutions for homes and businesses across Kerala with industry-leading safety standards.
            </motion.p>
